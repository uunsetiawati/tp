...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body rounded-circle">
      ...
      <hr>
      <p class="text-center">Kode OTP (Dikirim Melalui WA)</p>
      <form action="<?=site_url('auth/validationotp')?>" method="post" id="FormLogin">
        <div class="input-group mb-3">
          <input type="number" name="otp" class="form-control" placeholder="XXXXXX" required>
        ...
        <div class="row">          
          <div class="col-12">
            <button type="submit" name="login" class="btn btn-success btn-block">VALIDASI <i class="fas fa-key"></i></button>
          </div>
        </div>
