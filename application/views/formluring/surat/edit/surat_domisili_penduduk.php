        ...
        <form action="<?= base_url("permohonan/edit/".$surat->link)?>" method="post">
          ...
          <?php $this->load->view('permohonan/surat/edit/form_template')?>
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" name="ket_domisili" rows="4" placeholder="Ex: Dsn. Kemloko RT 03 RW 05" required><?= $this->input->post('ket_domisili') ?? $row->ket_domisili?></textarea>
