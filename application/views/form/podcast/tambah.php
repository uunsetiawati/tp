...
<?= form_open_multipart('')?>
  <div class="card-body">
    <?php $this->view("template/message/info_podcast")?>
    ...
    <div class="form-group">
     ...
     <select name="jenis" class="form-control" id="jenis" required>
       <option value="<?= set_value('jenis');?>">Pilihan : </option>       
     ...
     <?php echo form_error('jenis')?>
      ...
      <div class="input-group mb-3">
        <input type="text" name="brand" class="form-control" placeholder="Ex: BIKINKARYA CREATIVE MEDIA" value="<?= set_value('brand'); ?>" minlength="5" maxlength="50" required>
      </div>
    ...
    <div class="form-group">
      <label>Tanggal yang diinginkan untuk mengisi acara Bincang Jawara UKM</label>
      <div class="input-group mb-3">
    ...
    <div class="form-group">
      ...
      <?php echo form_error('sesi')?>
		...
		<div class="form-group">
     <label>Apakah anda sudah Vaksin Covid-19 ?</label>
     <select name="vaksin" class="form-control" id="vaksin" required>
       <option value="<?= set_value('vaksin');?>">Pilihan : </option>       
       <option value="sudah">Sudah</option>
       <option value="belum">Belum</option>
     </select>
     <?php echo form_error('vaksin')?>
   </div>
	 <div class="form-group">
     <label>Bersedia Hadir ke Malang dengan Biaya Sendiri ?</label>
     <select name="kehadiran" class="form-control" id="kehadiran" required>
       <option value="<?= set_value('kehadiran');?>">Pilihan : </option>       
...
<!--     
  ...
  <div class="card-footer">
    <button type="submit" class="btn btn-success" id="daftar-btn"><i class="fas fa-plane"></i> JADWALKAN</button>
  </div>
