...
<section class="content">
  <div class="container-fluid">
    <div class="card-header">
      <a href="<?= base_url('notulensi/edit/'.$row->id);?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Edit</a>          
      <a href="<?= base_url('notulensi/hapus/'.$row->id);?>" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i> Hapus</a>          
