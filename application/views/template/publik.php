...
<body class="hold-transition layout-top-nav layout-fixed layout-footer-fixed pace-warning">
	<div class="wrapper">
		...
		<nav class="main-header navbar navbar-expand navbar-green navbar-dark">
			...
			<ul class="navbar-nav">
				<li class="nav-item d-none d-sm-inline-block ">
					<div class="image">
						<a href="<?= base_url($this->uri->segment(1)) ?>/<?= $this->uri->segment(2) ?>"><img src="<?= base_url() ?>/assets/dist/img/logo-lembaga.png" style="width: 350px; height:100px;" alt="User Image"></a>
					</div>
				</li>
				<li class="nav-item d-lg-none">
					<div class="image">
						<a href="<?= base_url($this->uri->segment(1)) ?>/<?= $this->uri->segment(2) ?>"><img src="<?= base_url() ?>/assets/dist/img/logo-lembaga.png" style="width: 180px; height: 50px;" alt="User Image"></a>
					</div>
				</li>
			</ul>
		</nav>
		...
		<footer class="main-footer d-none d-sm-inline-block">
			<strong>&copy; <?= date("Y") ?> <a href="http://fitrahizulfalaq.blogspot.com"><?= ucfirst($this->fungsi->pilihan_advanced("setting", "kode", "pengembang")->row("keterangan")) ?></a>.</strong> <small> asromat</small>
