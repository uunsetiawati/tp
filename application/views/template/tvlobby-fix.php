...
<body class="hold-transition layout-top-nav layout-fixed layout-footer-fixed pace-warning">	
	<div class="wrapper">
		...
		<div class="content-wrapper" style="background-image: url(<?= base_url('assets/dist/img/bglobby.jpg')?>); background-repeat: repeat; background-position: center; background-repeat: no-repeat; background-size: cover; height: 10%;">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						...
						<br><br><br><br><br><br>
							<h2><?= $menu ?></h2>
							<h1>UPT Pelatihan Koperasi dan UKM Provinsi Jawa Timur dan Kampus UMKM Shopee</h1>
						</div><!-- /.col -->
					</div><!-- /.row -->
					<hr>
				</div><!-- /.container-fluid -->
